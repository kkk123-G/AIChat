...
CREATE TABLE user_recharge_record (
    ...
    recharge_no VARCHAR(40) NOT NULL COMMENT 'Unique recharge record number',
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uk_user_recharge_record_recharge_no (recharge_no),
    KEY idx_user_recharge_record_created_at (created_at),
