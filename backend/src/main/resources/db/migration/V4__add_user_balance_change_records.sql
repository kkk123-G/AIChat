CREATE TABLE IF NOT EXISTS user_balance_change_record (
    ...
    change_type VARCHAR(32) NOT NULL COMMENT 'RECHARGE, AI_CHAT or AI_CHAT_REFUND',
    ...
    PRIMARY KEY (id),
    KEY idx_user_balance_change_user_created_at (user_id, created_at),
